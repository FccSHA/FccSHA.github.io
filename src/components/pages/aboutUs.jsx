    ...
    return (
      <div className="sha-about-us">
        ...
        <div className="sha-carousel">
          <Carousel autoplay>
            <div><img src="/static/hongkong.png" alt="Hong Kong"/></div>
            <div><img src="/static/guangzhou.png" alt="Guang Zhou"/></div>
            <div><img src="/static/suzhou.png" alt="Su Zhou"/></div>
            <div><img src="/static/chengdu.png" alt="Cheng Du"/></div>
            <div><img src="/static/shanghai.jpeg" alt="Shang Hai"/></div>
          </Carousel>
        </div>
